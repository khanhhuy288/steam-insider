...
# the amount of downloaded reviews must be less than the reviews_limit
def download_reviews_for_app_id(
    ...
    while ((num_reviews is None) or (offset < num_reviews)) and ((reviews_limit is None) or (offset < reviews_limit)):
